...
class Subscription_expires_postmaster_notification extends Base_notification {
	...
	public $title = 'Subscription expires notifications';
	...
	protected $fields = array(
        ...
        'marker' => array(
			...
			'description' => '1 for notification 2 weeks before expiration, 2 for 3 days before and 3 when it is expired.',
		)
	);
